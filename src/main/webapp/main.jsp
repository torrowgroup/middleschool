        ...
        <thead>
            ...
            <c:forEach items="${requestScope.pagemsg.lists}" var="u">
                <tr>
                    ...
                    <th>${u.usPhone }</th>
                    <th>${u.usPicture }</th>
                    <th>${u.usIntroduction }</th>
                    <th>${u.usAchievements }</th>
...
<td class="td2">
   ...
   <span>
       <c:if test="${requestScope.pagemsg.currPage != 1}">
           <a href="${rootPath }/main?currentPage=1">[首页]</a>&nbsp;&nbsp;
           <a href="${rootPath}/main?currentPage=${requestScope.pagemsg.currPage-1}">[上一页]</a>&nbsp;&nbsp;
       </c:if>

       <c:if test="${requestScope.pagemsg.currPage != requestScope.pagemsg.totalPage}">
           <a href="${rootPath }/main?currentPage=${requestScope.pagemsg.currPage+1}">[下一页]</a>&nbsp;&nbsp;
           <a href="${rootPath }/main?currentPage=${requestScope.pagemsg.totalPage}">[尾页]</a>&nbsp;&nbsp;
       </c:if>
   </span>
</td>
</tr>
